disease_dic = {
    'Apple___Apple_scab': """ <b>Crop</b>: Apple <br/>Disease: Apple Scab<br/>
        ...
        <br/> <br/> <br/> 
        <br/> PEST DETECTION
        <br/> Description of Apple Scab Pest <br/> 
Apple scab, caused by the fungus Venturia inaequalis, is one of the most common and economically important diseases affecting apple trees. The disease is prevalent in regions with a wet, cool spring, which are ideal conditions for the development of the fungus.<br/> 

<br/><br/>
Link: https://www.canr.msu.edu/ipm/diseases/apple_scab
<br/> <br/><br/>Symptoms:<br/> 
Leaves: The first signs of apple scab are olive-green to black spots on the leaves, which can coalesce and cause the leaves to deform, yellow, and eventually drop prematurely.
Fruit: On the fruit, scab appears as rough, dark patches, which can become corky and cause the fruit to crack, significantly reducing its market value. Although the fruit remains edible, its appearance is greatly diminished.
<br/> Remedies for Apple Scab<br/> 
<br/> Cultural Controls:<br/> 
Sanitation: Remove and destroy fallen leaves and fruit, which can harbor the fungus over the winter.<br/> 
Pruning: Improve air circulation around the trees by pruning, which helps leaves and fruit dry more quickly, reducing the chances of infection.
<br/> Resistant Varieties: Plant scab-resistant apple varieties, which are less susceptible to the disease.
<br/> Chemical Controls:<br/> 
Fungicides: Apply fungicides during the susceptible periods, especially during the early spring when the leaves are first unfolding. The timing of fungicide applications is critical and often based on predictive models that consider weather conditions to optimize effectiveness while minimizing use.
""",
